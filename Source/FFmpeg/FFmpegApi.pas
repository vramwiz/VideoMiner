...
type
  ...
  Tav_hwdevice_ctx_create = function(device_ctx: PPAVBufferRef; dev_type: Integer; device: PAnsiChar; opts: Pointer; flags: Integer): Integer; cdecl;
  Tav_hwframe_transfer_data = function(dst: PAVFrame; const src: PAVFrame; flags: Integer): Integer; cdecl;
